...
<template>
  <ul class="list-inside list-disc">
    <li
      ...
      :class="[
        'font-ibm mb-[clamp(1.25rem,1.25rem+0.20vw,1.56rem)] max-w-8/10 px-4 py-2 text-[calc(0.85rem+0.2vw)] leading-[1.5] font-medium transition-colors duration-150 ease-in-out',
